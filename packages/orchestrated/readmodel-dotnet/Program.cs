...
const string saveFileName = "/totalUsdValue.txt";

string saveFileContent = File.Exists(saveFileName) ? File.ReadAllText(saveFileName) : "";
    ...
    using (IModel? channel = connection.CreateModel()) {
        ...
        consumer.Received += (model, ea) => {
            ...
            if (ev is OrderUsdRateAndValueAddedEvent oev && oev.Payload != null) {
                ...
                File.WriteAllText(saveFileName, totalUsdValue.ToString());
            }
